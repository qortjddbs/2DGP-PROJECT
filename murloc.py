...
class Idle:
    ...
    def draw(self):
        if self.murloc.face_dir == -1:
            self.murloc.images['Idle'][0].composite_draw(0, 'h', self.murloc.x, self.murloc.y)
        else:
            self.murloc.images['Idle'][0].draw(self.murloc.x, self.murloc.y)
...
class Attack:
    ...
    def draw(self):
        ...
        if self.murloc.face_dir == -1:
            ...
            self.murloc.images['Attack'][frame_index].draw(self.murloc.x, self.murloc.y)
...
class Skill:
    ...
    def draw(self):
        ...
        if self.murloc.face_dir == -1:
            ...
            self.murloc.images['Skill'][frame_index].draw(self.murloc.x, self.murloc.y)
...
class Ult:
    ...
    def draw(self):
        ...
        if self.murloc.face_dir == -1:
            ...
            self.murloc.images['Ult'][frame_index].draw(self.murloc.x, self.murloc.y)
